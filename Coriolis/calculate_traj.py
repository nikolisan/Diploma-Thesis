...
def plot_circle(center, radius):
    ...
    tickfmt.set_powerlimits((-3, 3))  # Or whatever your limits are . . .
...
def plot(radius, xc, yc, xi, yi, animate, speed):
    ...
    if animate:
        line1, = ax.plot([], [], 'b')
        line2, = ax.plot([], [], 'g--')
        ani = animation.FuncAnimation(plt.gcf(), update, len(xc), fargs=[xc, yc, xi, yi, line1, line2], interval=speed,
...
def run_cli(omega, numSteps, phi, R, x0, y0, u0, v0, animate, speed):
    [f, Ro, Th, xc, yc, xi, yi] = calculate(omega, numSteps, phi, R, x0, y0, u0, v0)
...
if __name__ == '__main__':
    ...
    u0 = -1
    v0 = 0
    run_cli(omega, numSteps, phi, R, x0, y0, u0, v0, animate=False, speed=5)
    ...
    u0 = 0
    v0 = 1
    run_cli(omega, numSteps, phi, R, x0, y0, u0, v0, animate=True, speed=5)
